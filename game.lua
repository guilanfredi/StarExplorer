...
local function fireLaser()
    ...
    transition.to(newLaser,{ y=-40, time=500, onComplete = 
        function () display.remove(newLaser); end      
    });
end
...
function scene:hide( event )
	...
	elseif ( phase == "did" ) then
		...
		Runtime:removeEventListener(eventName, callbackFunction )
        physics.pause()
